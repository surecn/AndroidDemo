package com.surecn.demo.opengles.ch06;
...
public class AirHockey3DRender implements GLSurfaceView.Renderer {
    ...
    private static final int POSITION_COMPONENT_COUNT = 4;//每个顶点的向量素
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //读取顶点着色器代码
        String vertexShaderSource = TextResourceReader.readTextFileFromResource(mContext, R.raw.ch06_vertex_shader);
        //读取片段着色器代码
        String fragmentShaderSource = TextResourceReader.readTextFileFromResource(mContext, R.raw.ch06_fragment_shader);
